...
<script type="text/javascript">
	...
	$(function(){
		...
		window.open("workbench/main/index.do","workareaFrame");//指定小窗口跳转
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				...
				<li class="liClass">
					...
					<ul id="no2" class="nav nav-pills nav-stacked collapse">
						...
						<li class="liClass"><a href="workbench/chart/transaction/tranChart.do" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 交易统计图表</a></li>
					</ul>
				</li>

...
<script type="text/javascript">
	...
	/*	$(".myHref").mouseout(function(){
		...
		$("#saveActivityRemarkBtn").click(function() {
			...
			//从作用域里面取数据需要变成字符串，因为右边的先执行，不转换成字符串编译器会把它当成变量
			var activityId = "${activity.id}";
			//发送ajax请求
			//const url = "workbench/activity/saveActivityRemarkController.do";
			$.ajax({
				url:"workbench/activity/saveActivityRemarkController.do",
				data:{

		...
		<c:forEach items="${transactionRemarkList}" var="tr">
			<div class="remarkDiv" id="div_${tr.id}" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">交易</font> <font color="gray">-</font> <b>"${transaction.name}"</b> <small style="color: gray;"> "${tr.createTIme}" 由"${tr.editFlag=="0"? tr.createBy:tr.editBy}"${tr.editFlag=="0"?"创建":"修改"}</small>
